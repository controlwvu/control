...
*/
	...
	(
		...
		'Prints out the file contents of a particular file generated by control, used for testing.', 
		'getFileContents', // (i.e. the name of the binary or shell script in bin/ that belongs to this test)
		array( 'S+T' ), // (supported file formats)
		$doesNotSupportIniFile 
	),
	/*
